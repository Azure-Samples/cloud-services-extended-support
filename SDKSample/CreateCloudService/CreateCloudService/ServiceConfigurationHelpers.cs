...
namespace CreateCloudService
{
    public static class ServiceConfigurationHelpers
    {
        ...
        private static void ConfigureRoleSettings(Dictionary<string, Utilities.RoleConfiguration> roleNameToPropertiesMapping, List<ServiceConfigurationRoleCertificate> certificates)
        {
