...
products:
- azure
description: "This code samples will show you how to create a Cloud Service using Azure SDK for .NET."
urlFragment: compute-create-vm
---
# Getting started - Managing Compute Resources using Azure .NET SDK

This code sample will show you how to create a Cloud Service using Azure SDK for .NET.
